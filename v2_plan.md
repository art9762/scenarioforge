...
### Фаза 3
- [ ] Админ видит всех пользователей, команды, коды
- [ ] Бан пользователя → он не может войти
- [ ] Изменение кредитов юзера/команды через админку
- [ ] Аудит-лог показывает последние действия
